            ...
            <div class="row">
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="name" id="name" placeholder="Nhập tên vài trò">
                        @error('name')
                                ...
                                <div class="row">
                                    @foreach($permissionsParentItem->permissionsChildrent as $permissionsParent)
                                        <div class="card-body text-primary col-md-3">
                                            <h5 class="card-title">
                                                <label>
                                                    <input type="checkbox" class="checkbox_childrent" name="permission_id[]" value="{{ $permissionsParent->id }}">
                                                </label>
